# Lead Follow-up Automation Sprint

Consent-first workflow automation offer for education and training businesses.
...
- lead intake fields for source, course interest, urgency, and owner;
- inquiry status board and weekly review template;
- FAQ reply draft library and staff handoff notes;
- follow-up reminder rhythm and data handling checklist.

## Boundaries

- No income, enrollment, or conversion promises.
- No private data scraping.
- No fake reviews, fake cases, or fake transactions.
- Counts as income: false.
- actual_net_rmb remains 0 until payment evidence and direct delivery cost evidence exist.
